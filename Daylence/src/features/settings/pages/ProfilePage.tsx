...
const recentActivity: Activity[] = [
  {
    icon: "🚗",
    label: "Itinéraire calculé",
    date: "Aujourd'hui, 14:32",
    detail: "Paris → Lyon en voiture",
  },
  {
    icon: "🍳",
    label: "Recette sauvegardée",
    date: "Hier, 19:15",
    detail: "Risotto aux champignons",
  },
  {
    icon: "😴",
    label: "Sommeil enregistré",
    date: "Hier, 07:00",
    detail: "7h42 — Score 85/100",
  },
  {
    icon: "💰",
    label: "Dépense ajoutée",
    date: "01 mars, 12:45",
    detail: "Courses — 47,30 €",
  },
  {
    icon: "✅",
    label: "Tâche terminée",
    date: "01 mars, 10:20",
    detail: "Finaliser la présentation Q1",
  },
  {
    icon: "🚆",
    label: "Trajet SNCF",
    date: "28 fév, 08:10",
    detail: "Marseille → Paris, TGV 6124",
  },
];

const stats = [
  { value: "142", label: "Tâches terminées", color: "var(--d-accent)" },
...
const badges = [
  ...
  { emoji: "🌟", label: "100 tâches", color: "var(--d-accent)" },
      ...
      <main className="sp-main sp-main--profile">
        ...
        <div className="pf-hero">
          ...
          <div className="pf-hero__content">
            <div className="pf-avatar">
              <span className="pf-avatar__letter">
        ...
        <div className="pf-body">
            ...
            <section className="sp-section">
              <div className="sp-section__header">
                ...
                <p className="sp-section__sub">
                  Récompenses obtenues pour votre activité.
                </p>
              </div>
          ...
          <div className="pf-col pf-col--right">
            ...
            <section className="sp-section">
              <div className="sp-section__header">
                <h3 className="sp-section__title sp-section__title--danger">
                  Zone dangereuse
                </h3>
              </div>
              <div className="sp-card sp-card--danger">
                ...
                <div className="sp-row">
                  <div className="sp-row__text">
                    ...
                    <span className="sp-row__desc">
                      Téléchargez une copie de toutes vos données au format
                      JSON.
                    </span>
                  </div>
